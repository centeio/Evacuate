...
public class Graph {
    ...
    public Graph(ArrayList<Vertex> vertices){
        ...
        for(Vertex v: vertices){
            this.vertices.put(v.getLocation(), v);
        }
    ...
    public boolean containsVertex(Vertex vertex){
        return this.vertices.get(vertex.getLocation()) != null;
    }
    ...
    public boolean addVertex(Vertex vertex, boolean overwriteExisting){
        Vertex current = this.vertices.get(vertex.getLocation());
        if(current != null){
        ...
        vertices.put(vertex.getLocation(), vertex);
        return true;
    }
     ...
     */
    public Vertex removeVertex(Location location){
        Vertex v = vertices.remove(location);
     ...
     */
    public Set<Location> vertexKeys(){
